...
export const metadata: Metadata = {
  title: "Diensten",
  description: "Onderhoud, reparatie, APK, banden, schadeherstel en inkoop. De diensten van MLAuto in Middelburg.",
};
    ...
    <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
      ...
      <section className="mt-14 rounded-xl bg-brand-dark p-6 text-white shadow-2 sm:p-8">
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <h2 className="font-display text-xl font-bold">Automatisch zeker?</h2>
