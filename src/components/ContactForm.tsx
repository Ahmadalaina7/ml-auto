      ...
      {sent ? (
        <div className="rounded-xl border border-strong/30 bg-strong/10 p-6">
          ...
          <p className="mt-2 text-sm text-ink">
            Stuur het vooraf ingevulde bericht om het bij ons af te leveren. Liever mailen?{" "}
        ...
        <form onSubmit={onSubmit}>
          <p className="mb-4 text-sm text-muted">
            Je bericht opent in WhatsApp, klaar om te versturen.
          </p>
          ...
          <div className="mt-4">
            ...
            <select id="c-subject" name="subject" required className={inputClass} defaultValue="">
